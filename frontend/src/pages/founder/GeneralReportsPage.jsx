...
export default function GeneralReportsPage()
{
    ...
    const dashboardPath = location.pathname.startsWith('/manager') ? '/manager/dashboard' : '/founder/dashboard'
