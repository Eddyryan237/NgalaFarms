        ...
        <div>
            <div className="mb-8">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-4xl font-bold text-gray-900">Yearly Report</h1>
                ...
                <>
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-8">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-6">
                            ...
                            <p className="text-lg font-bold text-purple-900 mt-2">{years} year{years > 1 ? 's' : ''}</p>
                    ...
                    <div className="grid grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="card">
                            ...
                            {report.expenses && report.expenses.length > 0 ? (
                                <div className="space-y-2 max-h-96 overflow-y-auto">
                                    ...
                                    {report.expenses.length > 20 && <p className="text-xs text-gray-600 text-center mt-2">... and {report.expenses.length - 20} more</p>}
                                </div>
                            ) : (
                        ...
                        <div className="card">
                            ...
                            {report.sales && report.sales.length > 0 ? (
                                <div className="space-y-2 max-h-96 overflow-y-auto">
                                    ...
                                    {report.sales.length > 20 && <p className="text-xs text-gray-600 text-center mt-2">... and {report.sales.length - 20} more</p>}
                                </div>
                            ) : (
                        ...
                        <div className="card">
                            ...
                            {report.production && report.production.length > 0 ? (
                                <div className="space-y-2 max-h-96 overflow-y-auto">
                                    ...
                                    {report.production.length > 20 && <p className="text-xs text-gray-600 text-center mt-2">... and {report.production.length - 20} more</p>}
                                </div>
                            ) : (
                        ...
                        {/* Harvests */}
                        <div className="card">
                            <h2 className="text-xl font-bold text-gray-900 mb-4">Harvests ({report.harvests?.length || 0})</h2>
                                        ...
                                        >
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-600">{formatDate(h.harvestDate)}</p>
                                                </div>
                                                <p className="text-xs font-semibold text-palm-600">{h.totalWeightKg}kg</p>
                                            </div>
                                        </div>
                                    ))}
                                    {report.harvests.length > 20 && <p className="text-xs text-gray-600 text-center mt-2">... and {report.harvests.length - 20} more</p>}
                                </div>
                            ) : (
