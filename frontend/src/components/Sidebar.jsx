...
export default function Sidebar({ isFounder, isOpen = true, onClose })
{
    ...
    return (
        <div className={`fixed md:relative w-64 bg-white border-r border-gray-200 h-screen overflow-y-auto z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
            ...
            <nav className="p-3 md:p-4 space-y-1 md:space-y-2 pb-24">
                {isFounder ? (
                    <>
            ...
            <div className="border-t border-gray-200 p-3 md:p-4 mt-auto fixed bottom-0 w-64 bg-white">
                <button
